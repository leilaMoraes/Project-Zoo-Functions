...
<details><summary> 1. Implemente a função `getSpeciesByIds`.</summary><br />
...
<details><summary> 2. Implemente a função `getAnimalsOlderThan`.</summary><br />
...
<details><summary> 3. Implemente a função `getEmployeeByName`.</summary><br />
...
<details><summary> 4. Implemente a função `getRelatedEmployees`.</summary><br />
...
<details><summary> 5. Implemente a função `countAnimals`.</summary><br />
...
<details><summary> 6. Obtenha ao menos 80% de cobertura de testes na função `handlerElephants`.</summary><br />
...
<details><summary> 7. Obtenha ao menos 90% de cobertura de testes na função `handlerElephants`.</summary><br />
...
<details><summary> 8. Implemente a função `calculateEntry`.</summary><br />
...
<details><summary> 9. Implemente a função `getSchedule`.</summary><br />
...
<details><summary> 10. Implemente a função `getOldestFromFirstSpecies`.</summary><br />
...
<details><summary> 11. Implemente a função `getEmployeesCoverage`.</summary><br />
...
<details><summary> 12. Obtenha ao menos 85% de cobertura de testes na função `getOpeningHours`.</summary><br />
...
<details><summary> 13. Obtenha ao menos 95% de cobertura de testes na função `getOpeningHours`.</summary><br />
...
<details><summary> 14. Implemente a função `getAnimalMap`.</summary><br />
...
<details><summary> 15. Obtenha 100% de cobertura de testes na função `handlerElephants`.</summary><br />
...
<details><summary> 16. Obtenha ao menos 100% de cobertura de testes na função `getOpeningHours`.</summary><br />
